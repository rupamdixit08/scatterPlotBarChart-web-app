...
const alcoholValue1 = data.filter((item) => item["Alcohol"] === 1);
const alcoholValue2 = data.filter((item) => item["Alcohol"] === 2);
const alcoholValue3 = data.filter((item) => item["Alcohol"] === 3);
...
const avgMalicAcidFor1 = calculateAverage(
  alcoholValue1.map((item) => item["Malic Acid"])
);
const avgMalicAcidFor2 = calculateAverage(
  alcoholValue2.map((item) => item["Malic Acid"])
);
const avgMalicAcidFor3 = calculateAverage(
  alcoholValue3.map((item) => item["Malic Acid"])
);
const newData = [
  { Alcohol: 1, "Malic Acid": avgMalicAcidFor1 },
  { Alcohol: 2, "Malic Acid": avgMalicAcidFor2 },
  { Alcohol: 3, "Malic Acid": avgMalicAcidFor3 },
];
const BarGraph = () => {
  return (
    <ResponsiveContainer width="100%" aspect={3}>
      ...
      >
        <Bar dataKey="Malic Acid" fill="green" />
